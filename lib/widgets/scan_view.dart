...
class ScanView extends StatelessWidget {
  ...
  List<Widget> _buildCombinedDeviceList(
    ...
    final Map<String, Map<String, dynamic>> discoveredMap = {
      for (var d in connectedDeviceController.discoveredDevices) d['id'] as String: d,
    };
...
class _InteractiveTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    } else if (connectedDeviceController.hasConnectingDevices &&
        device['id'] != null) {
